...
export class CliDriver
{
    ...
    private oauthCommands: string[] = ['ssh-proxy-config', 'connect', 'proxy', 'addrole', 'adduser', 'removerole', 'removeuser', 'describe', 'disconnect', 'attach', 'close', 'list-targets', 'lt', 'list-clusters', 'lk', 'list-connections', 'lc', 'copy', 'ssh-proxy', 'autodiscovery-script', 'generate']

    private mixpanelCommands: string[] = ['ssh-proxy-config', 'connect', 'proxy', 'addrole', 'adduser', 'removerole', 'removeuser', 'describe', 'disconnect', 'attach', 'close', 'list-targets', 'lt', 'list-clusters', 'lk', 'list-connections', 'lc', 'copy', 'ssh-proxy', 'autodiscovery-script', 'generate']
    
    private fetchCommands: string[] = ['connect', 'proxy', 'addrole', 'adduser', 'removerole', 'removeuser', 'describe', 'disconnect', 'attach', 'close', 'list-targets', 'lt', 'list-clusters', 'lk', 'list-connections', 'lc', 'copy', 'ssh-proxy', 'autodiscovery-script', 'generate']
