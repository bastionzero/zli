    ...
    public start()
    {
        ...
        yargs(process.argv.slice(2))
            ...
            .middleware(async (argv) => {
                ...
                // TODO : Clean exit instead of return?
                    return;
            ...
            .command(
                ...
                async (argv) => {
                    // TODO : Handle more gracefully addition of already added user - same for deletion
                    if (!! argv.add) {
            ...
            .command(
                ...
                async (argv) => {
                    if (!! argv.add) {
                        // TODO : Handle more gracefully addition of already added user - don't allow it?
