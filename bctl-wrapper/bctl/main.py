...
def main():
    ...
    token = subprocess.check_output('/Users/sidpremkumar/Documents/CommonwealthCrypto/zli/bin/zli-macos --configName dev getKubeToken -s', shell=True).decode('utf-8').strip()
